...
import 'package:tugas_pml__1_8_8/app/models/customers.dart';
import 'package:tugas_pml__1_8_8/app/models/order_item.dart';
import 'package:tugas_pml__1_8_8/app/models/orders.dart'; 
import 'package:tugas_pml__1_8_8/app/models/product.dart';
    ...
    try { 
      ...
      for (var item in orderItems) { 
        if (item is Map) { 
          ...
          var orderItemData = { 
            'order_item': OrderItem().generateId(), 
            'order_num': orderNum, 
